<!-- Modal de Check-in Formulários -->
<div id="checkin-modal" class="fixed inset-0 bg-gray-900/50 backdrop-blur-sm transition-opacity hidden" style="z-index: 9999;" aria-modal="true">
                    ...
                    <form id="form-checkin" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <!-- Processo e Evento lado a lado -->
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <!-- Processo -->
                                    <div>
                                        <label for="checkin-processo-id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">
                                            Processo (Opcional)
                                        </label>
                                        <select name="processo_id" 
                                                id="checkin-processo-id" 
                                    ...
                                    <!-- Evento -->
                                    <div>
                                        <label for="checkin-evento-id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">
                                            Evento (Opcional)
                                        </label>
                                        <select name="evento_id" 
                                                id="checkin-evento-id" 
                                                class="w-full rounded-md border-0 py-2 px-3 text-gray-900 dark:text-white ring-1 ring-inset ring-gray-300 dark:ring-gray-700 focus:ring-2 focus:ring-primary-600 dark:bg-gray-800 dark:focus:ring-primary-500 sm:text-sm sm:leading-6">
...
<!-- Mini Modal para Nome do Check-in -->
<div id="checkin-nome-modal" class="fixed inset-0 bg-gray-900/50 backdrop-blur-sm transition-opacity hidden" style="z-index: 10000;" aria-modal="true">
    <div class="fixed inset-0 z-10 overflow-y-auto">
        <div class="flex min-h-full items-center justify-center p-4">
            <div class="relative w-full max-w-md transform rounded-xl bg-white dark:bg-gray-800 shadow-xl transition-all">
                ...
                <!-- Corpo do Mini Modal -->
                <div class="px-6 py-4">
                    <form id="form-checkin-nome" class="space-y-4">
                        <div>
                            <label for="mini-checkin-nome" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">
                                Nome do Check-in *
                            </label>
                            <input type="text" 
                                   id="mini-checkin-nome" 
                                   class="w-full rounded-md border-0 py-2 px-3 text-gray-900 dark:text-white ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-primary-600 dark:bg-gray-800 dark:focus:ring-primary-500 sm:text-sm sm:leading-6" 
                                   placeholder="Ex: Check-in Evento da Manhã"
                                   required>
                        </div>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Após criar o check-in, você poderá configurar os itens e controle de acesso.
                        </p>
                    </form>
                </div>
                
                <!-- Footer do Mini Modal -->
                <div class="border-t dark:border-gray-700 px-6 py-4">
                    <div class="flex justify-end space-x-3">
                        <button type="button" 
                                id="cancel-checkin-nome-btn"
                                class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            Cancelar
                        </button>
                        <button type="button" 
                                id="create-checkin-btn"
