                ...
                ${ordens.map(ordem => {
                    ...
                    <div class="flex items-center gap-4 p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                        ...
                        <div class="flex items-center gap-1">
                            <button onclick="window.location.href='${window.APP_CONFIG.baseUrl}/src/pages/orden-culto/visualizar/?id=${ordem.id}'"
                            ...
                            <button onclick="window.location.href='${window.APP_CONFIG.baseUrl}/src/pages/orden-culto/criar/?id=${ordem.id}'"
