  ...
  <div class="max-w-8xl mx-auto">
        ...
        <div class="sm:flex sm:items-center sm:justify-between mb-8">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-700 dark:text-gray-400">Gerencie os check-ins do ministério</p>
            </div>
        ...
        <div id="error-container" class="hidden rounded-lg bg-red-50 dark:bg-red-900/50 p-4">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-red-800 dark:text-red-200" id="error-message">Erro ao carregar check-ins</h3>
                </div>
            </div>
        </div>
        ...
        <div id="empty-state" class="hidden text-center py-12">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">Nenhum check-in encontrado</h3>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Comece criando um novo check-in para o ministério.</p>
        </div>

        <!-- Lista de Check-ins -->
        <div id="checkins-grid" class="hidden">
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody id="checkins-list" class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            <!-- Check-ins serão inseridos aqui via JavaScript -->
                        </tbody>
                    </table>
                </div>
                <!-- Paginação -->
