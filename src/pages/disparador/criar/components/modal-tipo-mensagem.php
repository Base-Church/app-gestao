    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="message-type-card cursor-pointer p-4 border-2 border-gray-200 dark:border-gray-600 rounded-lg hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-200" data-type="carousel" onclick="selectMessageType('carousel')">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h4 class="font-medium text-gray-900 dark:text-white">Carrossel</h4>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Cartões com imagens e botões</p>
                        </div>
                    </div>
                </div>
            </div>
