...
<div class="mt-4 sm:mt-0 flex items-center gap-4">
    ...
    <select id="formulario-filter" 
            class="block rounded-md border-0 py-2 pl-3 pr-10 text-gray-900 dark:text-white bg-white dark:bg-gray-800 ring-1 ring-inset ring-gray-300 dark:ring-gray-700 focus:ring-2 focus:ring-primary-600 dark:focus:ring-primary-500 sm:text-sm sm:leading-6">
