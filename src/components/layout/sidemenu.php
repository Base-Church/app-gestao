...
$menuIds = array_column($authorizedMenus, 'id');
    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3">
            <div class="space-y-1">
                <!-- Início (ID: 1) -->
                <?php if (hasAccess('1')): ?>
                    <a href="<?php echo $_ENV['URL_BASE']; ?>/src/pages/inicio" 
                ...
                <?php if (hasAccess('2')): ?>
                    <div class="space-y-1">
                        ...
                        <div id="escalasSubMenu" class="hidden pl-11 space-y-1"> <!-- Adicione 'hidden' aqui -->
                            ...
                            <?php if (hasAccess('3')): ?>
                                <a href="<?php echo $_ENV['URL_BASE']; ?>/src/pages/escalas" 
                            ...
                            <!-- Modelos (ID: 4) -->
                            <?php if (hasAccess('4')): ?>
                                <a href="<?php echo $_ENV['URL_BASE']; ?>/src/pages/modelos" 
                                   class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-all duration-200">
                                    <span>Modelos</span>
                                </a>
                            <?php endif; ?>
                            <?php if (hasAccess('4')): ?>
                                <a href="<?php echo $_ENV['URL_BASE']; ?>/src\pages\musicas\" 
                                   class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-all duration-200">
                                    <span>Músicas</span>
                                </a>
                            <?php endif; ?>
                ...
                <!-- Ministérios (ID: 5) -->
                <?php if (hasAccess('5')): ?>
                    <a href="<?php echo $_ENV['URL_BASE']; ?>/src/pages/ministerios" 
                       class="flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-all duration-200 group">
                        <svg class="w-5 h-5 mr-3 text-gray-500 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Liderança (ID: 6) -->
                <?php if (hasAccess('6')): ?>
                    <a href="<?php echo $_ENV['URL_BASE']; ?>/src/pages/lideres" 
                       class="flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-all duration-200 group">
                        <svg class="w-5 h-5 mr-3 text-gray-500 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                        </svg>
                ...
                <?php if (hasAccess('7')): ?>
                    <div class="space-y-1">
                        ...
                        <div id="atividadesSubMenu" class="pl-11 space-y-1">
                            <!-- Categorias (ID: 8) -->
                            <?php if (hasAccess('8')): ?>
                                <a href="<?php echo $_ENV['URL_BASE']; ?>/src/pages/categoria-atividade" 
                                   class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-all duration-200">
                            ...
                            <!-- Atividades (ID: 9) -->
                            <?php if (hasAccess('9')): ?>
                                <a href="<?php echo $_ENV['URL_BASE']; ?>/src/pages/atividades" 
                                   class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-all duration-200">
                ...
                <!-- Eventos (ID: 10) -->
                <?php if (hasAccess('10')): ?>
                    <a href="<?php echo $_ENV['URL_BASE']; ?>/src/pages/eventos" 
                       class="flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-all duration-200 group">
                        <svg class="w-5 h-5 mr-3 text-gray-500 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                ...
                <!-- Recados (ID: 11) -->
                <?php if (hasAccess('11')): ?>
                    <a href="<?php echo $_ENV['URL_BASE']; ?>/src/pages/recados" 
                       class="flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-all duration-200 group">
                        <svg class="w-5 h-5 mr-3 text-gray-500 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php if (hasAccess('12')): ?>
                    <div class="space-y-1">
                        ...
                        <div id="voluntariosSubMenu" class="pl-11 space-y-1">
                            ...
                            <!-- Calendário (ID: 14) -->
                            <?php if (hasAccess('14')): ?>
                                <a href="<?php echo $_ENV['URL_BASE']; ?>/src/pages/calendario" 
                                   class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-all duration-200">
                            ...
                            <!-- Observações (ID: 15) -->
                            <?php if (hasAccess('15')): ?>
                                <a href="<?php echo $_ENV['URL_BASE']; ?>/src/pages/observacoes" 
                                   class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-all duration-200">
                ...
                <?php if (hasAccess('16')): ?>
                    <a href="<?php echo $_ENV['URL_BASE']; ?>/src/pages/orden-culto" 
                       class="flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-all duration-200 group">
                        <svg class="w-5 h-5 mr-3 text-gray-500 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mt-8">
                ...
                <div class="mt-4 space-y-1">
                    <a href="<?php echo $_ENV['URL_BASE']; ?>/src/pages/configuracoes" class="flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-all duration-200 group">
                        <svg class="w-5 h-5 mr-3 text-gray-500 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<!-- User Menu Dropdown -->
<div id="userMenu" class="hidden absolute bottom-4 left-4 lg:left-60 z-50 w-56 rounded-lg shadow-lg py-1 bg-white dark:bg-gray-800 ring-1 ring-black/5 dark:ring-white/10">
    <div class="px-4 py-2 border-b dark:border-gray-700">
        <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo $_SESSION['user']['nome']; ?></p>
        <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo $_SESSION['user']['nivel']; ?></p>
    </div>
    <a href="<?php echo $_ENV['URL_BASE']; ?>/src/services/auth/logout.php" class="block px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-700">
...
<script src="<?php echo $_ENV['URL_BASE']; ?>/src/js/ministerio-switcher.js"></script>